...
namespace Golden_Village {
    ...
    public partial class mysqlDataSet : global::System.Data.DataSet {
        ...
        public partial class productsDataTable : global::System.Data.TypedTableBase<productsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public productsRow AddproductsRow(string Id, string name, string details, double quantity, double retailprice, double wholesaleprice) {
        ...
        public partial class productsRow : global::System.Data.DataRow {
            ...
            public double wholesaleprice {
                get {
                    return ((double)(this[this.tableproducts.wholesalepriceColumn]));
                }
                set {
...
namespace Golden_Village.mysqlDataSetTableAdapters {
    ...
    public partial class productsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[products] WHERE (([Id] = @Original_Id) AND ([name] = @Original_name) AND ((@IsNull_details = 1 AND [details] IS NULL) OR ([details] = @Original_details)) AND ([quantity] = @Original_quantity) AND ([retailprice] = @Original_retailprice) AND ([wholesaleprice] = @Original_wholesaleprice))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[products] ([Id], [name], [details], [quantity], [retailprice], [wholesaleprice]) VALUES (@Id, @name, @details, @quantity, @retailprice, @wholesaleprice);
SELECT Id, name, details, quantity, retailprice, wholesaleprice FROM products WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[products] SET [Id] = @Id, [name] = @name, [details] = @details, [quantity] = @quantity, [retailprice] = @retailprice, [wholesaleprice] = @wholesaleprice WHERE (([Id] = @Original_Id) AND ([name] = @Original_name) AND ((@IsNull_details = 1 AND [details] IS NULL) OR ([details] = @Original_details)) AND ([quantity] = @Original_quantity) AND ([retailprice] = @Original_retailprice) AND ([wholesaleprice] = @Original_wholesaleprice));
SELECT Id, name, details, quantity, retailprice, wholesaleprice FROM products WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Golden_Village.Properties.Settings.Default.mysqlConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, details, quantity, retailprice, wholesaleprice FROM dbo.products" +
                "";
        ...
        public virtual int Fill(mysqlDataSet.productsDataTable dataTable) {
        ...
        public virtual mysqlDataSet.productsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            mysqlDataSet.productsDataTable dataTable = new mysqlDataSet.productsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(mysqlDataSet.productsDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Id, string Original_name, string Original_details, double Original_quantity, double Original_retailprice, double Original_wholesaleprice) {
            if ((Original_Id == null)) {
            ...
            this.Adapter.DeleteCommand.Parameters[5].Value = ((double)(Original_retailprice));
            this.Adapter.DeleteCommand.Parameters[6].Value = ((double)(Original_wholesaleprice));
        ...
        public virtual int Insert(string Id, string name, string details, double quantity, double retailprice, double wholesaleprice) {
            if ((Id == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((double)(retailprice));
            this.Adapter.InsertCommand.Parameters[5].Value = ((double)(wholesaleprice));
        ...
        public virtual int Update(string Id, string name, string details, double quantity, double retailprice, double wholesaleprice, string Original_Id, string Original_name, string Original_details, double Original_quantity, double Original_retailprice, double Original_wholesaleprice) {
            if ((Id == null)) {
                throw new global::System.ArgumentNullException("Id");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((double)(retailprice));
            this.Adapter.UpdateCommand.Parameters[5].Value = ((double)(wholesaleprice));
            if ((Original_Id == null)) {
                throw new global::System.ArgumentNullException("Original_Id");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[11].Value = ((double)(Original_retailprice));
            this.Adapter.UpdateCommand.Parameters[12].Value = ((double)(Original_wholesaleprice));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string details, double quantity, double retailprice, double wholesaleprice, string Original_Id, string Original_name, string Original_details, double Original_quantity, double Original_retailprice, double Original_wholesaleprice) {
            return this.Update(Original_Id, name, details, quantity, retailprice, wholesaleprice, Original_Id, Original_name, Original_details, Original_quantity, Original_retailprice, Original_wholesaleprice);
        }
    }
